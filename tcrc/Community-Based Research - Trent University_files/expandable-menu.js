...
(function ($, Drupal, window, document, undefined) {
  Drupal.behaviors.trentApplicantNav = {
    attach: function(context, settings) {
      new TrentThemeNav('.primary-menu-mobile '); /*The future students menu on the homepage*/
      new TrentThemeNav('.secondary-menu-mobile '); /*The applicant menu in each applicant section*/
      $('.secondary-menu-mobile  .content').hide();
      $('.secondary-menu-mobile  h2').click(function() {
        $(this).siblings('.content').toggle();
        $(this).toggleClass('selected');
      });
      $('.primary-menu-mobile  .content').hide();
      $('#block-menu-block-1 h2,.primary-menu-mobile  h2').click(function() {
        $(this).siblings('.content').toggle();
        $(this).toggleClass('selected');
      });
    }
  ...
  var TrentThemeNav = function(selector) {
  ...
  TrentThemeNav.prototype.highlight = function(active) {
  ...
  TrentThemeNav.prototype.setToggles = function() {
    var self = this;
