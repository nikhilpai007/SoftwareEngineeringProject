...
if($result = $link -> query($sql)){
  while ($row = $result -> fetch_row()){
    if ($row[31] == " submitted") {
      // code...
    $projectArray[$counter2] = array($row[0],$row[1],$row[2],$row[3],$row[4],$row[5],$row[6],$row[7],$row[8],$row[9],$row[10],$row[11],
    $row[12],$row[13],$row[14],$row[15],$row[16],$row[17],$row[18],$row[19],$row[20],$row[21],$row[22],$row[23],$row[24],$row[25],$row[26],$row[27],
              ...
              <table id="example1" class="table table-bordered table-hover">
                ...
                <tbody>
                  ...
                  <?php
                    ...
                    echo "<td><a href='projectprofile.php?id={$projectArray[$i]['0']}' style='color:red'>Approve</a></td>";
